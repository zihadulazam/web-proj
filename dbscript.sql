...
PRIMARY KEY (ID),
UNIQUE (NAME),
CONSTRAINT PRICE_RANGE_CHECK CHECK ((MIN_VALUE < MAX_VALUE))
);
...
FOREIGN KEY (ID_COORDINATE) REFERENCES COORDINATES (ID) ON DELETE CASCADE);
...
FOREIGN KEY (ID_RESTAURANT) REFERENCES RESTAURANTS (ID) ON DELETE CASCADE,
FOREIGN KEY (ID_OPENING_HOURS_RANGE) REFERENCES OPENING_HOURS_RANGES (ID) ON DELETE CASCADE
);
...
PRIMARY KEY(ID),
FOREIGN KEY(ID) REFERENCES REPLIES(ID) ON DELETE CASCADE
);
...
CREATE INDEX REVIEWS_PHOTO ON REVIEWS(ID_PHOTO);
...
INSERT INTO CUISINES(NAME) VALUES('AMERICANA');
INSERT INTO CUISINES(NAME) VALUES('ASIATICA');
INSERT INTO CUISINES(NAME) VALUES('AFRICANA');
INSERT INTO CUISINES(NAME) VALUES('CINESE');
INSERT INTO CUISINES(NAME) VALUES('JAPONESE');
INSERT INTO CUISINES(NAME) VALUES('GIAPPONESE');
INSERT INTO CUISINES(NAME) VALUES('SUSHI');
INSERT INTO CUISINES(NAME) VALUES('INDIANA');
INSERT INTO CUISINES(NAME) VALUES('ITALIANA');
INSERT INTO CUISINES(NAME) VALUES('PIZZA');
INSERT INTO CUISINES(NAME) VALUES('FRANCESE');
INSERT INTO CUISINES(NAME) VALUES('SPAGNOLA');
INSERT INTO CUISINES(NAME) VALUES('PESCE');
INSERT INTO CUISINES(NAME) VALUES('CARNE');
INSERT INTO CUISINES(NAME) VALUES('MESSICANA');
INSERT INTO CUISINES(NAME) VALUES('FAST-FOOD');
INSERT INTO CUISINES(NAME) VALUES('VEGERATIANA');

INSERT INTO PRICE_RANGES(NAME,MIN_VALUE,MAX_VALUE) VALUES('MOLTO BASSO',2,10);
INSERT INTO PRICE_RANGES(NAME,MIN_VALUE,MAX_VALUE) VALUES('BASSO',7,15);
INSERT INTO PRICE_RANGES(NAME,MIN_VALUE,MAX_VALUE) VALUES('MEDIO',10,20);
INSERT INTO PRICE_RANGES(NAME,MIN_VALUE,MAX_VALUE) VALUES('ALTO',20,50);
INSERT INTO PRICE_RANGES(NAME,MIN_VALUE,MAX_VALUE) VALUES('MOLTO ALTO',50,100);
