...
>>>>>>> f47a14d7e8c88c4ecb2dec8cc3d682c761d28885
                                                            ...
                                                            <div class="col-md-8 restaurant-body">
                                                                ...
                                                                <p class="info-row"><span class="info-lable"><span class="glyphicon glyphicon glyphicon-euro" aria-hidden="true"></span> Prezzo: </span><span class="info-text"><c:out value="${topRatedRisto.getPriceRange().getName()}"/></span></p>
...
>>>>>>> f47a14d7e8c88c4ecb2dec8cc3d682c761d28885
                                                            ...
                                                            <div class="col-md-8 restaurant-body">
                                                                ...
                                                                <p class="info-row"><span class="info-lable"><span class="glyphicon glyphicon glyphicon-euro" aria-hidden="true"></span> Prezzo: </span><span class="info-text"><c:out value="${topReviewRisto.getPriceRange().getName()}" /></span></p>
